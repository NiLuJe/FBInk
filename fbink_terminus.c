    ...
    terminus_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x00) {
		...
		return terminus_block47[codepoint - 0x5d0];
	} else if (codepoint >= 0x1e0c && codepoint <= 0x1e0d) {
		return terminus_block48[codepoint - 0x1e0c];
	} else if (codepoint >= 0x1e34 && codepoint <= 0x1e37) {
		return terminus_block49[codepoint - 0x1e34];
	} else if (codepoint >= 0x1e40 && codepoint <= 0x1e47) {
		return terminus_block50[codepoint - 0x1e40];
	} else if (codepoint >= 0x1e6c && codepoint <= 0x1e6d) {
		return terminus_block51[codepoint - 0x1e6c];
	} else if (codepoint >= 0x1eb8 && codepoint <= 0x1eb9) {
		return terminus_block52[codepoint - 0x1eb8];
	} else if (codepoint >= 0x1ebc && codepoint <= 0x1ebd) {
		return terminus_block53[codepoint - 0x1ebc];
	} else if (codepoint >= 0x1eca && codepoint <= 0x1ecd) {
		return terminus_block54[codepoint - 0x1eca];
	} else if (codepoint >= 0x1ee4 && codepoint <= 0x1ee5) {
		return terminus_block55[codepoint - 0x1ee4];
	} else if (codepoint >= 0x1ef8 && codepoint <= 0x1ef9) {
		return terminus_block56[codepoint - 0x1ef8];
	} else if (codepoint >= 0x2000 && codepoint <= 0x2022) {
		return terminus_block57[codepoint - 0x2000];
		...
		return terminus_block60[codepoint - 0x2032];
	} else if (codepoint >= 0x2039 && codepoint <= 0x203a) {
		return terminus_block61[codepoint - 0x2039];
		...
		return terminus_block64[codepoint - 0x2070];
	} else if (codepoint >= 0x2074 && codepoint <= 0x208e) {
		return terminus_block65[codepoint - 0x2074];
	} else if (codepoint >= 0x2090 && codepoint <= 0x2098) {
		return terminus_block66[codepoint - 0x2090];
		...
		return terminus_block73[codepoint - 0x210e];
	} else if (codepoint >= 0x2115 && codepoint <= 0x2116) {
		return terminus_block74[codepoint - 0x2115];
		...
		return terminus_block81[codepoint - 0x2190];
		...
		return terminus_block106[codepoint - 0x2308];
    ...
    terminusb_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x00) {
		...
		return terminusb_block47[codepoint - 0x5d0];
	} else if (codepoint >= 0x1e0c && codepoint <= 0x1e0d) {
		return terminusb_block48[codepoint - 0x1e0c];
	} else if (codepoint >= 0x1e34 && codepoint <= 0x1e37) {
		return terminusb_block49[codepoint - 0x1e34];
	} else if (codepoint >= 0x1e40 && codepoint <= 0x1e47) {
		return terminusb_block50[codepoint - 0x1e40];
	} else if (codepoint >= 0x1e6c && codepoint <= 0x1e6d) {
		return terminusb_block51[codepoint - 0x1e6c];
	} else if (codepoint >= 0x1eb8 && codepoint <= 0x1eb9) {
		return terminusb_block52[codepoint - 0x1eb8];
	} else if (codepoint >= 0x1ebc && codepoint <= 0x1ebd) {
		return terminusb_block53[codepoint - 0x1ebc];
	} else if (codepoint >= 0x1eca && codepoint <= 0x1ecd) {
		return terminusb_block54[codepoint - 0x1eca];
	} else if (codepoint >= 0x1ee4 && codepoint <= 0x1ee5) {
		return terminusb_block55[codepoint - 0x1ee4];
	} else if (codepoint >= 0x1ef8 && codepoint <= 0x1ef9) {
		return terminusb_block56[codepoint - 0x1ef8];
	} else if (codepoint >= 0x2000 && codepoint <= 0x2022) {
		return terminusb_block57[codepoint - 0x2000];
	} else if (codepoint == 0x2026) {
		return terminusb_block58[0];
	} else if (codepoint == 0x2030) {
		return terminusb_block59[0];
	} else if (codepoint >= 0x2032 && codepoint <= 0x2033) {
		return terminusb_block60[codepoint - 0x2032];
	} else if (codepoint >= 0x2039 && codepoint <= 0x203a) {
		return terminusb_block61[codepoint - 0x2039];
	} else if (codepoint == 0x203c) {
		return terminusb_block62[0];
	} else if (codepoint == 0x203e) {
		return terminusb_block63[0];
	} else if (codepoint >= 0x2070 && codepoint <= 0x2071) {
		return terminusb_block64[codepoint - 0x2070];
	} else if (codepoint >= 0x2074 && codepoint <= 0x208e) {
		return terminusb_block65[codepoint - 0x2074];
	} else if (codepoint >= 0x2090 && codepoint <= 0x2098) {
		return terminusb_block66[codepoint - 0x2090];
	} else if (codepoint == 0x209a) {
		...
		return terminusb_block73[codepoint - 0x210e];
	} else if (codepoint >= 0x2115 && codepoint <= 0x2116) {
		return terminusb_block74[codepoint - 0x2115];
	} else if (codepoint == 0x211a) {
		...
		return terminusb_block81[codepoint - 0x2190];
	} else if (codepoint == 0x21a4) {
		...
		return terminusb_block87[codepoint - 0x21cb];
	} else if (codepoint >= 0x21d0 && codepoint <= 0x21d5) {
		return terminusb_block88[codepoint - 0x21d0];
	} else if (codepoint == 0x2200) {
		return terminusb_block89[0];
	} else if (codepoint >= 0x2203 && codepoint <= 0x220d) {
		return terminusb_block90[codepoint - 0x2203];
	} else if (codepoint >= 0x2212 && codepoint <= 0x2216) {
		return terminusb_block91[codepoint - 0x2212];
	} else if (codepoint >= 0x2219 && codepoint <= 0x221a) {
		return terminusb_block92[codepoint - 0x2219];
	} else if (codepoint >= 0x221e && codepoint <= 0x221f) {
		return terminusb_block93[codepoint - 0x221e];
	} else if (codepoint == 0x2225) {
		return terminusb_block94[0];
	} else if (codepoint >= 0x2227 && codepoint <= 0x222a) {
		return terminusb_block95[codepoint - 0x2227];
	} else if (codepoint == 0x2248) {
		return terminusb_block96[0];
	} else if (codepoint >= 0x2260 && codepoint <= 0x2261) {
		return terminusb_block97[codepoint - 0x2260];
	} else if (codepoint >= 0x2264 && codepoint <= 0x2265) {
		return terminusb_block98[codepoint - 0x2264];
	} else if (codepoint >= 0x226a && codepoint <= 0x226b) {
		return terminusb_block99[codepoint - 0x226a];
	} else if (codepoint >= 0x2282 && codepoint <= 0x2283) {
		return terminusb_block100[codepoint - 0x2282];
	} else if (codepoint >= 0x2286 && codepoint <= 0x2287) {
		return terminusb_block101[codepoint - 0x2286];
	} else if (codepoint == 0x22a5) {
		return terminusb_block102[0];
	} else if (codepoint >= 0x22c2 && codepoint <= 0x22c3) {
		return terminusb_block103[codepoint - 0x22c2];
	} else if (codepoint == 0x2300) {
		return terminusb_block104[0];
	} else if (codepoint == 0x2302) {
		return terminusb_block105[0];
	} else if (codepoint >= 0x2308 && codepoint <= 0x230b) {
		return terminusb_block106[codepoint - 0x2308];
	} else if (codepoint == 0x2310) {
		return terminusb_block107[0];
	} else if (codepoint == 0x2319) {
		return terminusb_block108[0];
	} else if (codepoint >= 0x2320 && codepoint <= 0x2321) {
		return terminusb_block109[codepoint - 0x2320];
	} else if (codepoint >= 0x239b && codepoint <= 0x23a9) {
		return terminusb_block110[codepoint - 0x239b];
	} else if (codepoint >= 0x23ab && codepoint <= 0x23af) {
		return terminusb_block111[codepoint - 0x23ab];
	} else if (codepoint >= 0x23ba && codepoint <= 0x23bd) {
		return terminusb_block112[codepoint - 0x23ba];
	} else if (codepoint == 0x23d0) {
		return terminusb_block113[0];
	} else if (codepoint >= 0x2409 && codepoint <= 0x240d) {
		return terminusb_block114[codepoint - 0x2409];
	} else if (codepoint == 0x2424) {
		return terminusb_block115[0];
	} else if (codepoint >= 0x2500 && codepoint <= 0x2503) {
		return terminusb_block116[codepoint - 0x2500];
	} else if (codepoint >= 0x2508 && codepoint <= 0x254b) {
		return terminusb_block117[codepoint - 0x2508];
	} else if (codepoint >= 0x2550 && codepoint <= 0x2593) {
		return terminusb_block118[codepoint - 0x2550];
	} else if (codepoint >= 0x2596 && codepoint <= 0x25a0) {
		return terminusb_block119[codepoint - 0x2596];
	} else if (codepoint == 0x25ac) {
		...
		return terminusb_block129[codepoint - 0x25ca];
	} else if (codepoint == 0x25cf) {
		return terminusb_block130[0];
	} else if (codepoint >= 0x25d8 && codepoint <= 0x25d9) {
		return terminusb_block131[codepoint - 0x25d8];
	} else if (codepoint >= 0x263a && codepoint <= 0x263c) {
		return terminusb_block132[codepoint - 0x263a];
	} else if (codepoint == 0x2640) {
		...
		return terminusb_block137[codepoint - 0x2665];
	} else if (codepoint >= 0x266a && codepoint <= 0x266b) {
		return terminusb_block138[codepoint - 0x266a];
	} else if (codepoint >= 0x2713 && codepoint <= 0x2714) {
		return terminusb_block139[codepoint - 0x2713];
	} else if (codepoint >= 0x2717 && codepoint <= 0x2718) {
		return terminusb_block140[codepoint - 0x2717];
	} else if (codepoint >= 0x27e8 && codepoint <= 0x27eb) {
		return terminusb_block141[codepoint - 0x27e8];
	} else if (codepoint >= 0x2800 && codepoint <= 0x28ff) {
		return terminusb_block142[codepoint - 0x2800];
	} else if (codepoint == 0x2e2c) {
		return terminusb_block143[0];
	} else if (codepoint >= 0xe0a0 && codepoint <= 0xe0a2) {
		return terminusb_block144[codepoint - 0xe0a0];
	} else if (codepoint >= 0xe0b0 && codepoint <= 0xe0b3) {
		return terminusb_block145[codepoint - 0xe0b0];
	} else if (codepoint == 0xf6be) {
