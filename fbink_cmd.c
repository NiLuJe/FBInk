    ...
    show_helpmsg(void)
{
	printf(
	    ...
	    "\t\t\tNote that user-supplied values will be silently clamped to safe boundaries (from 1 to around 45 for most fonts, and from 1 to around 30 for TALL).\n"
#else
	    "\t\t\tNote that user-supplied values will be silently clamped to safe boundaries (from 1 to around 45).\n"
#endif
