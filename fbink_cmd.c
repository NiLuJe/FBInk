...
#	endif
	    ...
	    "\tfbink -i hello,world.png -g x=-10,y=11 -x 5 -y 5\n"
	    "\t\tDraws the content of the image file hello,world.png, starting at the sixth line + 11px and the sixth column - 10px\n"
	    "\n"
	    "NOTES:\n"
