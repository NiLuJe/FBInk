...
You can also launch the `fbink` CLI tool itself with no argument for a quick manual & rundown of its capabilities. Also available directly in [the main source file](https://github.com/NiLuJe/FBInk/blob/master/fbink_cmd.c).
