...
// Slightly clunky flags for RGB565 handling in put_pixel,
// in order to have some fast paths depending on the input pixel format...
#define PXFMT_RGB32	0u
#define PXFMT_RGB565	1u
#define PXFMT_GRAY8	2u
