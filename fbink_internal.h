...
#	define FBINK_FALLBACK_VERSION "v1.25.0-git"
...
#define PFLOG(fmt, ...) ({ LOG("[%s] " fmt, __PRETTY_FUNCTION__, ##__VA_ARGS__); })
...
static int refresh_kobo_mtk(int, const struct mxcfb_rect, const FBInkConfig*);
