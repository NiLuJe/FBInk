    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
		...
		return cozette_block111[codepoint - 0x229du];
		...
		return cozette_block114[codepoint - 0x22c4u];
	} else if (codepoint >= 0x22eeu && codepoint <= 0x22f1u) {
		return cozette_block115[codepoint - 0x22eeu];
		...
		return cozette_block168[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block169[codepoint - 0x2b80u];
		...
		return cozette_block173[codepoint - 0xe000u];
	} else if (codepoint >= 0xe0a0u && codepoint <= 0xe0a3u) {
		return cozette_block174[codepoint - 0xe0a0u];
	} else if (codepoint >= 0xe0b0u && codepoint <= 0xe0bfu) {
		return cozette_block175[codepoint - 0xe0b0u];
		...
		return cozette_block179[codepoint - 0xe20au];
		...
		return cozette_block184[codepoint - 0xe28au];
	} else if (codepoint >= 0xe5fbu && codepoint <= 0xe5fcu) {
		return cozette_block185[codepoint - 0xe5fbu];
	} else if (codepoint >= 0xe5feu && codepoint <= 0xe628u) {
		return cozette_block186[codepoint - 0xe5feu];
	} else if (codepoint >= 0xe62au && codepoint <= 0xe62du) {
		return cozette_block187[codepoint - 0xe62au];
		...
		return cozette_block220[codepoint - 0xe7b4u];
		...
		return cozette_block223[codepoint - 0xe7c4u];
	} else if (codepoint >= 0xeffau && codepoint <= 0xeffdu) {
		return cozette_block224[codepoint - 0xeffau];
		...
		return cozette_block234[codepoint - 0xf031u];
		...
		return cozette_block237[codepoint - 0xf048u];
	} else if (codepoint >= 0xf050u && codepoint <= 0xf05au) {
		return cozette_block238[codepoint - 0xf050u];
	} else if (codepoint >= 0xf067u && codepoint <= 0xf06au) {
		return cozette_block239[codepoint - 0xf067u];
		...
		return cozette_block243[codepoint - 0xf07bu];
		...
		return cozette_block253[codepoint - 0xf0c3u];
		...
		return cozette_block307[codepoint - 0xf461u];
		...
		return cozette_block310[codepoint - 0xf481u];
	} else if (codepoint >= 0xf489u && codepoint <= 0xf48au) {
		return cozette_block311[codepoint - 0xf489u];
		...
		return cozette_block332[codepoint - 0xf7cau];
		...
		return cozette_block337[0];
	} else if (codepoint >= 0xf81fu && codepoint <= 0xf820u) {
		return cozette_block338[codepoint - 0xf81fu];
	} else if (codepoint >= 0xf834u && codepoint <= 0xf835u) {
		return cozette_block339[codepoint - 0xf834u];
		...
		return cozette_block343[codepoint - 0xfa7du];
	} else if (codepoint >= 0xfaa8u && codepoint <= 0xfaa9u) {
		return cozette_block344[codepoint - 0xfaa8u];
		...
		return cozette_block349[codepoint - 0xfc5bu];
		...
		return cozette_block353[codepoint - 0xfd05u];
		...
		return cozette_block356[codepoint - 0xfe54u];
	} else if (codepoint >= 0xfe68u && codepoint <= 0xfe6bu) {
		return cozette_block357[codepoint - 0xfe68u];
