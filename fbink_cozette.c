    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
		...
		return cozette_block112[codepoint - 0x2282u];
	} else if (codepoint >= 0x2295u && codepoint <= 0x2296u) {
		return cozette_block113[codepoint - 0x2295u];
		...
		return cozette_block118[codepoint - 0x22eeu];
		...
		return cozette_block129[codepoint - 0x234du];
		...
		return cozette_block185[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block186[codepoint - 0x2b80u];
		...
		return cozette_block190[codepoint - 0xe000u];
	} else if (codepoint >= 0xe0a0u && codepoint <= 0xe0a3u) {
		return cozette_block191[codepoint - 0xe0a0u];
	} else if (codepoint >= 0xe0b0u && codepoint <= 0xe0bfu) {
		return cozette_block192[codepoint - 0xe0b0u];
		...
		return cozette_block196[codepoint - 0xe20au];
		...
		return cozette_block202[codepoint - 0xe28au];
	} else if (codepoint >= 0xe5fbu && codepoint <= 0xe5fcu) {
		return cozette_block203[codepoint - 0xe5fbu];
	} else if (codepoint >= 0xe5feu && codepoint <= 0xe628u) {
		return cozette_block204[codepoint - 0xe5feu];
	} else if (codepoint >= 0xe62au && codepoint <= 0xe62du) {
		return cozette_block205[codepoint - 0xe62au];
		...
		return cozette_block238[codepoint - 0xe7b4u];
		...
		return cozette_block241[codepoint - 0xe7c4u];
	} else if (codepoint >= 0xeffau && codepoint <= 0xeffdu) {
		return cozette_block242[codepoint - 0xeffau];
		...
		return cozette_block252[codepoint - 0xf031u];
		...
		return cozette_block255[codepoint - 0xf048u];
	} else if (codepoint >= 0xf050u && codepoint <= 0xf05au) {
		return cozette_block256[codepoint - 0xf050u];
	} else if (codepoint >= 0xf067u && codepoint <= 0xf06au) {
		return cozette_block257[codepoint - 0xf067u];
		...
		return cozette_block261[codepoint - 0xf07bu];
		...
		return cozette_block271[codepoint - 0xf0c3u];
		...
		return cozette_block321[codepoint - 0xf40eu];
		...
		return cozette_block326[codepoint - 0xf431u];
		...
		return cozette_block329[codepoint - 0xf449u];
	} else if (codepoint >= 0xf461u && codepoint <= 0xf462u) {
		return cozette_block330[codepoint - 0xf461u];
		...
		return cozette_block357[codepoint - 0xf6b7u];
		...
		return cozette_block366[codepoint - 0xf72au];
		...
		return cozette_block372[codepoint - 0xf7cau];
		...
		return cozette_block379[codepoint - 0xf81fu];
	} else if (codepoint >= 0xf831u && codepoint <= 0xf837u) {
		return cozette_block380[codepoint - 0xf831u];
		...
		return cozette_block386[codepoint - 0xfa7du];
	} else if (codepoint >= 0xfaa8u && codepoint <= 0xfaa9u) {
		return cozette_block387[codepoint - 0xfaa8u];
		...
		return cozette_block393[codepoint - 0xfc5bu];
		...
		return cozette_block397[codepoint - 0xfd05u];
		...
		return cozette_block400[codepoint - 0xfe54u];
	} else if (codepoint >= 0xfe68u && codepoint <= 0xfe6bu) {
		return cozette_block401[codepoint - 0xfe68u];
