    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
		...
		return cozette_block242[codepoint - 0xf07bu];
		...
		return cozette_block312[codepoint - 0xf578u];
		...
		return cozette_block317[codepoint - 0xf7cau];
		...
		return cozette_block321[codepoint - 0xf81fu];
	} else if (codepoint >= 0xfa7du && codepoint <= 0xfa80u) {
		return cozette_block322[codepoint - 0xfa7du];
	} else if (codepoint >= 0xfaa8u && codepoint <= 0xfaa9u) {
		return cozette_block323[codepoint - 0xfaa8u];
		...
		return cozette_block326[codepoint - 0xfc5bu];
