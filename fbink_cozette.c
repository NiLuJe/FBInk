    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
	...
	} else if (codepoint >= 0xa0u && codepoint <= 0x165u) {
		return cozette_block2[codepoint - 0xa0u];
	} else if (codepoint >= 0x168u && codepoint <= 0x171u) {
		return cozette_block3[codepoint - 0x168u];
	} else if (codepoint >= 0x178u && codepoint <= 0x17eu) {
		return cozette_block4[codepoint - 0x178u];
	} else if (codepoint == 0x192u) {
		return cozette_block5[0];
	} else if (codepoint == 0x1c3u) {
		return cozette_block6[0];
	} else if (codepoint >= 0x246u && codepoint <= 0x247u) {
		return cozette_block7[codepoint - 0x246u];
	} else if (codepoint == 0x2c6u) {
		return cozette_block8[0];
	} else if (codepoint == 0x2dcu) {
		return cozette_block9[0];
	} else if (codepoint >= 0x391u && codepoint <= 0x3a1u) {
		return cozette_block10[codepoint - 0x391u];
	} else if (codepoint >= 0x3a3u && codepoint <= 0x3acu) {
		return cozette_block11[codepoint - 0x3a3u];
	} else if (codepoint >= 0x3b1u && codepoint <= 0x3c9u) {
		return cozette_block12[codepoint - 0x3b1u];
	} else if (codepoint >= 0x400u && codepoint <= 0x482u) {
		return cozette_block13[codepoint - 0x400u];
	} else if (codepoint >= 0x48au && codepoint <= 0x52fu) {
		return cozette_block14[codepoint - 0x48au];
		...
		return cozette_block47[codepoint - 0x2500u];
	} else if (codepoint >= 0x25a0u && codepoint <= 0x25a1u) {
		return cozette_block48[codepoint - 0x25a0u];
		...
		return cozette_block78[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block79[codepoint - 0x2b80u];
		...
		return cozette_block82[codepoint - 0xe000u];
	} else if (codepoint >= 0xe0a0u && codepoint <= 0xe0a3u) {
		return cozette_block83[codepoint - 0xe0a0u];
	} else if (codepoint >= 0xe0b0u && codepoint <= 0xe0bfu) {
		return cozette_block84[codepoint - 0xe0b0u];
		...
		return cozette_block87[codepoint - 0xe20au];
		...
		return cozette_block113[codepoint - 0xe7a7u];
		...
		return cozette_block122[codepoint - 0xf00bu];
		...
		return cozette_block131[codepoint - 0xf048u];
	} else if (codepoint >= 0xf050u && codepoint <= 0xf052u) {
		return cozette_block132[codepoint - 0xf050u];
	} else if (codepoint >= 0xf055u && codepoint <= 0xf05au) {
		return cozette_block133[codepoint - 0xf055u];
		...
		return cozette_block137[codepoint - 0xf07bu];
		...
		return cozette_block151[codepoint - 0xf113u];
		...
		return cozette_block154[codepoint - 0xf130u];
		...
		return cozette_block194[codepoint - 0xf578u];
		...
		return cozette_block197[codepoint - 0xf7cau];
		...
		return cozette_block208[codepoint - 0xfd05u];
