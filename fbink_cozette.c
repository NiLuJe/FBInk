    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
		...
		return cozette_block107[codepoint - 0x2248u];
		...
		return cozette_block130[codepoint - 0x234du];
		...
		return cozette_block185[codepoint - 0x276cu];
		...
		return cozette_block188[codepoint - 0x27e6u];
	} else if (codepoint >= 0x2801u && codepoint <= 0x28ffu) {
		return cozette_block189[codepoint - 0x2801u];
		...
		return cozette_block193[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block194[codepoint - 0x2b80u];
		...
		return cozette_block211[codepoint - 0xe5fbu];
	} else if (codepoint >= 0xe5feu && codepoint <= 0xe628u) {
		return cozette_block212[codepoint - 0xe5feu];
	} else if (codepoint >= 0xe62au && codepoint <= 0xe62du) {
		return cozette_block213[codepoint - 0xe62au];
		...
		return cozette_block246[codepoint - 0xe7b4u];
		...
		return cozette_block249[codepoint - 0xe7c4u];
	} else if (codepoint >= 0xeffau && codepoint <= 0xeffdu) {
		return cozette_block250[codepoint - 0xeffau];
		...
		return cozette_block260[codepoint - 0xf031u];
		...
		return cozette_block263[codepoint - 0xf048u];
	} else if (codepoint >= 0xf050u && codepoint <= 0xf05au) {
		return cozette_block264[codepoint - 0xf050u];
	} else if (codepoint >= 0xf067u && codepoint <= 0xf06au) {
		return cozette_block265[codepoint - 0xf067u];
		...
		return cozette_block269[codepoint - 0xf07bu];
		...
		return cozette_block279[codepoint - 0xf0c3u];
		...
		return cozette_block329[codepoint - 0xf40eu];
		...
		return cozette_block334[codepoint - 0xf431u];
		...
		return cozette_block337[codepoint - 0xf449u];
	} else if (codepoint >= 0xf461u && codepoint <= 0xf462u) {
		return cozette_block338[codepoint - 0xf461u];
		...
		return cozette_block365[codepoint - 0xf6b7u];
		...
		return cozette_block374[codepoint - 0xf72au];
		...
		return cozette_block380[codepoint - 0xf7cau];
		...
		return cozette_block387[codepoint - 0xf81fu];
	} else if (codepoint >= 0xf831u && codepoint <= 0xf837u) {
		return cozette_block388[codepoint - 0xf831u];
		...
		return cozette_block394[codepoint - 0xfa7du];
	} else if (codepoint >= 0xfaa8u && codepoint <= 0xfaa9u) {
		return cozette_block395[codepoint - 0xfaa8u];
		...
		return cozette_block401[codepoint - 0xfc5bu];
		...
		return cozette_block405[codepoint - 0xfd05u];
