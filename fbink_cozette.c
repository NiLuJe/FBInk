    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
		...
		return cozette_block95[codepoint - 0x2160u];
	} else if (codepoint >= 0x2168u && codepoint <= 0x216au) {
		return cozette_block96[codepoint - 0x2168u];
	} else if (codepoint >= 0x2170u && codepoint <= 0x217bu) {
		return cozette_block97[codepoint - 0x2170u];
	} else if (codepoint >= 0x2190u && codepoint <= 0x219bu) {
		return cozette_block98[codepoint - 0x2190u];
	} else if (codepoint >= 0x21a2u && codepoint <= 0x21a7u) {
		return cozette_block99[codepoint - 0x21a2u];
	} else if (codepoint >= 0x21a9u && codepoint <= 0x21acu) {
		return cozette_block100[codepoint - 0x21a9u];
	} else if (codepoint >= 0x21afu && codepoint <= 0x21c3u) {
		return cozette_block101[codepoint - 0x21afu];
	} else if (codepoint >= 0x21cbu && codepoint <= 0x21ccu) {
		return cozette_block102[codepoint - 0x21cbu];
	} else if (codepoint >= 0x21d0u && codepoint <= 0x21d5u) {
		return cozette_block103[codepoint - 0x21d0u];
	} else if (codepoint >= 0x21e0u && codepoint <= 0x21e3u) {
		return cozette_block104[codepoint - 0x21e0u];
	} else if (codepoint >= 0x21f1u && codepoint <= 0x21f2u) {
		return cozette_block105[codepoint - 0x21f1u];
	} else if (codepoint >= 0x2200u && codepoint <= 0x222cu) {
		return cozette_block106[codepoint - 0x2200u];
	} else if (codepoint >= 0x2234u && codepoint <= 0x2237u) {
		return cozette_block107[codepoint - 0x2234u];
		...
		return cozette_block129[codepoint - 0x2335u];
		...
		return cozette_block168[codepoint - 0x263fu];
		...
		return cozette_block170[codepoint - 0x2669u];
	} else if (codepoint >= 0x2680u && codepoint <= 0x2685u) {
		return cozette_block171[codepoint - 0x2680u];
		...
		return cozette_block187[codepoint - 0x276cu];
		...
		return cozette_block190[codepoint - 0x27e6u];
	} else if (codepoint >= 0x2800u && codepoint <= 0x28ffu) {
		return cozette_block191[codepoint - 0x2800u];
		...
		return cozette_block196[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block197[codepoint - 0x2b80u];
		...
		return cozette_block210[codepoint - 0x3057u];
		...
		return cozette_block216[codepoint - 0x3068u];
		...
		return cozette_block257[codepoint - 0xe0a0u];
	} else if (codepoint >= 0xe0b0u && codepoint <= 0xe0bfu) {
		return cozette_block258[codepoint - 0xe0b0u];
		...
		return cozette_block262[codepoint - 0xe20au];
		...
		return cozette_block268[codepoint - 0xe28au];
	} else if (codepoint >= 0xe5fau && codepoint <= 0xe628u) {
		return cozette_block269[codepoint - 0xe5fau];
		...
		return cozette_block312[codepoint - 0xe7c4u];
	} else if (codepoint >= 0xeffau && codepoint <= 0xeffdu) {
		return cozette_block313[codepoint - 0xeffau];
		...
		return cozette_block345[codepoint - 0xf0c3u];
		...
		return cozette_block348[codepoint - 0xf0f3u];
		...
		return cozette_block370[codepoint - 0xf1b6u];
		...
		return cozette_block379[codepoint - 0xf200u];
		...
		return cozette_block390[codepoint - 0xf2c7u];
	} else if (codepoint >= 0xf2dbu && codepoint <= 0xf2dcu) {
		return cozette_block391[codepoint - 0xf2dbu];
		...
		return cozette_block400[codepoint - 0xf40eu];
		...
		return cozette_block407[codepoint - 0xf431u];
		...
		return cozette_block410[codepoint - 0xf449u];
	} else if (codepoint >= 0xf461u && codepoint <= 0xf462u) {
		return cozette_block411[codepoint - 0xf461u];
		...
		return cozette_block439[codepoint - 0xf6b7u];
		...
		return cozette_block448[codepoint - 0xf72au];
		...
		return cozette_block454[codepoint - 0xf7cau];
		...
		return cozette_block462[codepoint - 0xf831u];
		...
		return cozette_block468[codepoint - 0xfa7du];
	} else if (codepoint >= 0xfaa8u && codepoint <= 0xfaa9u) {
		return cozette_block469[codepoint - 0xfaa8u];
		...
		return cozette_block476[codepoint - 0xfc5bu];
		...
		return cozette_block483[codepoint - 0xfe54u];
	} else if (codepoint >= 0xfe68u && codepoint <= 0xfe6bu) {
		return cozette_block484[codepoint - 0xfe68u];
	} else if (codepoint >= 0xff01u && codepoint <= 0xff0eu) {
		return cozette_block485[codepoint - 0xff01u];
	} else if (codepoint >= 0xff10u && codepoint <= 0xff3bu) {
		return cozette_block486[codepoint - 0xff10u];
	} else if (codepoint >= 0xff3du && codepoint <= 0xff3eu) {
		return cozette_block487[codepoint - 0xff3du];
	} else if (codepoint >= 0xff40u && codepoint <= 0xff5du) {
		return cozette_block488[codepoint - 0xff40u];
	} else if (codepoint >= 0xff5fu && codepoint <= 0xff60u) {
		return cozette_block489[codepoint - 0xff5fu];
