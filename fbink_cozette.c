    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
		...
		return cozette_block45[codepoint - 0x2500u];
	} else if (codepoint >= 0x25a0u && codepoint <= 0x25a1u) {
		return cozette_block46[codepoint - 0x25a0u];
		...
		return cozette_block76[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block77[codepoint - 0x2b80u];
		...
		return cozette_block80[codepoint - 0xe000u];
	} else if (codepoint >= 0xe0a0u && codepoint <= 0xe0a3u) {
		return cozette_block81[codepoint - 0xe0a0u];
	} else if (codepoint >= 0xe0b0u && codepoint <= 0xe0bfu) {
		return cozette_block82[codepoint - 0xe0b0u];
		...
		return cozette_block85[codepoint - 0xe20au];
		...
		return cozette_block111[codepoint - 0xe7a7u];
		...
		return cozette_block120[codepoint - 0xf00bu];
		...
		return cozette_block129[codepoint - 0xf048u];
	} else if (codepoint >= 0xf050u && codepoint <= 0xf052u) {
		return cozette_block130[codepoint - 0xf050u];
	} else if (codepoint >= 0xf055u && codepoint <= 0xf05au) {
		return cozette_block131[codepoint - 0xf055u];
		...
		return cozette_block135[codepoint - 0xf07bu];
		...
		return cozette_block149[codepoint - 0xf113u];
		...
		return cozette_block152[codepoint - 0xf130u];
		...
		return cozette_block192[codepoint - 0xf578u];
		...
		return cozette_block195[codepoint - 0xf7cau];
		...
		return cozette_block206[codepoint - 0xfd05u];
