    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
		...
		return cozette_block188[codepoint - 0x276cu];
		...
		return cozette_block191[codepoint - 0x27e6u];
	} else if (codepoint >= 0x2800u && codepoint <= 0x28ffu) {
		return cozette_block192[codepoint - 0x2800u];
		...
		return cozette_block198[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block199[codepoint - 0x2b80u];
		...
		return cozette_block221[codepoint - 0x3082u];
	} else if (codepoint == 0x3085u) {
		return cozette_block222[0];
	} else if (codepoint >= 0x3087u && codepoint <= 0x308bu) {
		return cozette_block223[codepoint - 0x3087u];
	} else if (codepoint >= 0x308du && codepoint <= 0x308eu) {
		return cozette_block224[codepoint - 0x308du];
	} else if (codepoint >= 0x3092u && codepoint <= 0x3096u) {
		return cozette_block225[codepoint - 0x3092u];
	} else if (codepoint >= 0x309bu && codepoint <= 0x30a1u) {
		return cozette_block226[codepoint - 0x309bu];
	} else if (codepoint == 0x30a3u) {
		return cozette_block227[0];
	} else if (codepoint == 0x30a5u) {
		return cozette_block228[0];
	} else if (codepoint == 0x30a7u) {
		return cozette_block229[0];
	} else if (codepoint >= 0x30a9u && codepoint <= 0x30aau) {
		return cozette_block230[codepoint - 0x30a9u];
	} else if (codepoint >= 0x30acu && codepoint <= 0x30adu) {
		return cozette_block231[codepoint - 0x30acu];
		...
		return cozette_block261[codepoint - 0xe000u];
	} else if (codepoint >= 0xe0a0u && codepoint <= 0xe0a3u) {
		return cozette_block262[codepoint - 0xe0a0u];
	} else if (codepoint >= 0xe0b0u && codepoint <= 0xe0bfu) {
		return cozette_block263[codepoint - 0xe0b0u];
		...
		return cozette_block267[codepoint - 0xe20au];
		...
		return cozette_block275[codepoint - 0xe28au];
	} else if (codepoint >= 0xe5fau && codepoint <= 0xe628u) {
		return cozette_block276[codepoint - 0xe5fau];
	} else if (codepoint >= 0xe62au && codepoint <= 0xe62du) {
		return cozette_block277[codepoint - 0xe62au];
		...
		return cozette_block310[codepoint - 0xe795u];
		...
		return cozette_block352[codepoint - 0xf0a8u];
		...
		return cozette_block355[codepoint - 0xf0c3u];
		...
		return cozette_block358[codepoint - 0xf0f3u];
		...
		return cozette_block368[codepoint - 0xf130u];
		...
		return cozette_block382[codepoint - 0xf1b6u];
		...
		return cozette_block391[codepoint - 0xf200u];
		...
		return cozette_block412[codepoint - 0xf40eu];
		...
		return cozette_block419[codepoint - 0xf431u];
		...
		return cozette_block422[codepoint - 0xf449u];
	} else if (codepoint >= 0xf460u && codepoint <= 0xf462u) {
		return cozette_block423[codepoint - 0xf460u];
		...
		return cozette_block452[codepoint - 0xf6a6u];
	} else if (codepoint >= 0xf6b7u && codepoint <= 0xf6b9u) {
		return cozette_block453[codepoint - 0xf6b7u];
		...
		return cozette_block462[codepoint - 0xf72au];
		...
		return cozette_block468[codepoint - 0xf7cau];
		...
		return cozette_block475[codepoint - 0xf81fu];
	} else if (codepoint >= 0xf831u && codepoint <= 0xf837u) {
		return cozette_block476[codepoint - 0xf831u];
		...
		return cozette_block490[codepoint - 0xfc5bu];
		...
		return cozette_block494[codepoint - 0xfd05u];
		...
		return cozette_block497[codepoint - 0xfe54u];
	} else if (codepoint >= 0xfe68u && codepoint <= 0xfe6bu) {
		return cozette_block498[codepoint - 0xfe68u];
	} else if (codepoint >= 0xff01u && codepoint <= 0xff0eu) {
		return cozette_block499[codepoint - 0xff01u];
	} else if (codepoint >= 0xff10u && codepoint <= 0xff3bu) {
		return cozette_block500[codepoint - 0xff10u];
	} else if (codepoint >= 0xff3du && codepoint <= 0xff3eu) {
		return cozette_block501[codepoint - 0xff3du];
	} else if (codepoint >= 0xff40u && codepoint <= 0xff5du) {
		return cozette_block502[codepoint - 0xff40u];
	} else if (codepoint >= 0xff5fu && codepoint <= 0xff60u) {
		return cozette_block503[codepoint - 0xff5fu];
		...
		return cozette_block540[codepoint - 0xf0079u];
	} else if (codepoint >= 0xf009au && codepoint <= 0xf00a0u) {
		return cozette_block541[codepoint - 0xf009au];
	} else if (codepoint >= 0xf00c0u && codepoint <= 0xf00c6u) {
		return cozette_block542[codepoint - 0xf00c0u];
		...
		return cozette_block559[0];
	} else if (codepoint >= 0xf05afu && codepoint <= 0xf05b0u) {
		return cozette_block560[codepoint - 0xf05afu];
		...
		return cozette_block565[0];
	} else if (codepoint == 0xf07d4u) {
		return cozette_block566[0];
