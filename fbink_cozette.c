    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
	...
	} else if (codepoint >= 0x2170u && codepoint <= 0x2175u) {
		return cozette_block92[codepoint - 0x2170u];
	} else if (codepoint >= 0x2178u && codepoint <= 0x217au) {
		return cozette_block93[codepoint - 0x2178u];
		...
		return cozette_block169[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block170[codepoint - 0x2b80u];
		...
		return cozette_block174[codepoint - 0xe000u];
	} else if (codepoint >= 0xe0a0u && codepoint <= 0xe0a3u) {
		return cozette_block175[codepoint - 0xe0a0u];
	} else if (codepoint >= 0xe0b0u && codepoint <= 0xe0bfu) {
		return cozette_block176[codepoint - 0xe0b0u];
		...
		return cozette_block180[codepoint - 0xe20au];
		...
		return cozette_block185[codepoint - 0xe28au];
	} else if (codepoint >= 0xe5fbu && codepoint <= 0xe5fcu) {
		return cozette_block186[codepoint - 0xe5fbu];
	} else if (codepoint >= 0xe5feu && codepoint <= 0xe628u) {
		return cozette_block187[codepoint - 0xe5feu];
	} else if (codepoint >= 0xe62au && codepoint <= 0xe62du) {
		return cozette_block188[codepoint - 0xe62au];
		...
		return cozette_block221[codepoint - 0xe7b4u];
		...
		return cozette_block224[codepoint - 0xe7c4u];
	} else if (codepoint >= 0xeffau && codepoint <= 0xeffdu) {
		return cozette_block225[codepoint - 0xeffau];
		...
		return cozette_block235[codepoint - 0xf031u];
		...
		return cozette_block238[codepoint - 0xf048u];
	} else if (codepoint >= 0xf050u && codepoint <= 0xf05au) {
		return cozette_block239[codepoint - 0xf050u];
	} else if (codepoint >= 0xf067u && codepoint <= 0xf06au) {
		return cozette_block240[codepoint - 0xf067u];
		...
		return cozette_block244[codepoint - 0xf07bu];
		...
		return cozette_block254[codepoint - 0xf0c3u];
		...
		return cozette_block308[codepoint - 0xf461u];
		...
		return cozette_block311[codepoint - 0xf481u];
	} else if (codepoint >= 0xf489u && codepoint <= 0xf48au) {
		return cozette_block312[codepoint - 0xf489u];
		...
		return cozette_block319[codepoint - 0xf578u];
