    ...
    cozette_get_bitmap(uint32_t codepoint)
{
	if (codepoint <= 0x7fu) {
		...
		return cozette_block66[codepoint - 0x2500u];
	} else if (codepoint >= 0x2596u && codepoint <= 0x25a1u) {
		return cozette_block67[codepoint - 0x2596u];
		...
		return cozette_block98[codepoint - 0x2b60u];
	} else if (codepoint >= 0x2b80u && codepoint <= 0x2b83u) {
		return cozette_block99[codepoint - 0x2b80u];
		...
		return cozette_block102[codepoint - 0xe000u];
	} else if (codepoint >= 0xe0a0u && codepoint <= 0xe0a3u) {
		return cozette_block103[codepoint - 0xe0a0u];
	} else if (codepoint >= 0xe0b0u && codepoint <= 0xe0bfu) {
		return cozette_block104[codepoint - 0xe0b0u];
		...
		return cozette_block108[codepoint - 0xe20au];
		...
		return cozette_block113[codepoint - 0xe28au];
	} else if (codepoint >= 0xe5fbu && codepoint <= 0xe5fcu) {
		return cozette_block114[codepoint - 0xe5fbu];
	} else if (codepoint >= 0xe5feu && codepoint <= 0xe628u) {
		return cozette_block115[codepoint - 0xe5feu];
	} else if (codepoint >= 0xe62au && codepoint <= 0xe62du) {
		return cozette_block116[codepoint - 0xe62au];
		...
		return cozette_block148[codepoint - 0xe7b4u];
		...
		return cozette_block151[codepoint - 0xe7c4u];
	} else if (codepoint >= 0xeffau && codepoint <= 0xeffdu) {
		return cozette_block152[codepoint - 0xeffau];
		...
		return cozette_block163[codepoint - 0xf031u];
		...
		return cozette_block166[codepoint - 0xf048u];
	} else if (codepoint >= 0xf050u && codepoint <= 0xf05au) {
		return cozette_block167[codepoint - 0xf050u];
	} else if (codepoint >= 0xf067u && codepoint <= 0xf06au) {
		return cozette_block168[codepoint - 0xf067u];
		...
		return cozette_block171[codepoint - 0xf07bu];
		...
		return cozette_block239[codepoint - 0xf578u];
		...
		return cozette_block244[codepoint - 0xf7cau];
		...
		return cozette_block248[codepoint - 0xf81fu];
	} else if (codepoint >= 0xfa7du && codepoint <= 0xfa80u) {
		return cozette_block249[codepoint - 0xfa7du];
	} else if (codepoint >= 0xfaa8u && codepoint <= 0xfaa9u) {
		return cozette_block250[codepoint - 0xfaa8u];
		...
		return cozette_block253[codepoint - 0xfc5bu];
