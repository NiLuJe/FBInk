    ...
    unscii_get_bitmap(uint32_t codepoint)
{
	...
	} else if (codepoint == 0x2117) {
		return unscii_block61[0];
	} else if (codepoint == 0x2120) {
	...
	} else if (codepoint == 0x2218) {
		return unscii_block71[0];
	} else if (codepoint == 0x221a) {
	...
	} else if (codepoint == 0x2625) {
		return unscii_block82[0];
	} else if (codepoint == 0x2628) {
	...
	} else if (codepoint == 0xfe84) {
		return unscii_block103[0];
	} else if (codepoint == 0xfe87) {
